...
class Task extends StatefulWidget {
  final String nome;
  final String srcImagem;
  final int dificuldade;

  const Task(this.nome, this.srcImagem, this.dificuldade, {Key? key}) : super(key: key);
                ...
                children: [
                  SizedBox(
                    ...
                    child: LinearProgressIndicator(
                      color: Colors.white,
                      value: (widget.dificuldade > 0 ? (nivel / widget.dificuldade) / 10 : 0),
                    ),
                  ),
                  Text(
                    "Nível $nivel",
